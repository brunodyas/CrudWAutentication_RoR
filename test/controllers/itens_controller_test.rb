...
class ItensControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create iten" do
    assert_difference('Iten.count') do
      post itens_url, params: { iten: { id_seq: @iten.id_seq, level: @iten.level, modelo: @iten.modelo, nome: @iten.nome, quantidade: @iten.quantidade } }
    end
  ...
  test "should update iten" do
    patch iten_url(@iten), params: { iten: { id_seq: @iten.id_seq, level: @iten.level, modelo: @iten.modelo, nome: @iten.nome, quantidade: @iten.quantidade } }
